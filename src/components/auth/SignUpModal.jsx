          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl w-full max-w-md border border-slate-700 shadow-2xl p-8">
            ...
            <div className="mb-6">
              <button
                ...
                className="w-full bg-white hover:bg-slate-100 text-slate-900 font-semibold py-2 rounded-lg border border-slate-300 transition-colors flex items-center justify-center gap-2 text-sm"
              >
  ...
  if (signUpStep === 4) {
    return (
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl w-full max-w-md border border-slate-700 shadow-2xl p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-2">
              Verify Your Email
            </h2>
